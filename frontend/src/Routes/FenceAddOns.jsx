...
const Hero = () => (
  <div className="relative h-[400px] sm:h-[500px] md:h-[600px] lg:h-[750px] w-full mt-10 md:mt-0">
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center w-[90%] md:w-[80%] lg:w-[70%]">
      ...
      Fences can be enhanced with additional accessories that boost both aesthetics and security. Depending on your needs, whether it's for illumination and design or enhanced security, Unifence provides a range of fence add-ons. These options are carefully crafted to integrate seamlessly, adding value to your fence system.
      </p>
      <Link
        to="/contact"
  ...
  const Products = () => {
    const products = [
      ...
      },
      {
        id:2,
        image: con,
        title: 'UNIFENCE CONCERTINA COIL',
        description: 'Concertina coils provide an effective, expandable security solution to deter unauthorized access and enhance perimeter defense.',
