  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[700px] w-full">
        ...
        />
        <h1 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-2xl md:text-3xl lg:text-5xl font-bold text-white">
          CONTACT US
        </h1>
      </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <p className="flex items-start gap-2">
              ...
              Unit 2:<br/>
              Khewat No.-273/256, Khata No.-292,<br/>
              Killa No.- 18/21/1/2/1/2, Nathupur,<br/>
